...
namespace OneWare.SourceControl.Models
{
    public class GitRepositoryModel : ObservableObject
    {
        ...
        public GitRepositoryModel(IProjectRoot project, Repository repository, IProjectExplorerService projectExplorerService)
        {
            Project = project;
        ...
        public ObservableCollection<SourceControlFileModel> Changes { get; set; } = new();
        public ObservableCollection<SourceControlFileModel> StagedChanges { get; set; } = new();
        public ObservableCollection<SourceControlFileModel> MergeChanges { get; set; } = new();
        ...
        public void Refresh(SourceControlViewModel sourceControlViewModel)
        {
            ...
            {
                // Ensure you have a logger instance or inject it as well
