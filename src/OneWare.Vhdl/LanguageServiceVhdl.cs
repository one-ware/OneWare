...
namespace OneWare.Vhdl
{
    public class LanguageServiceVhdl(string workspace, ISettingsService settingsService, IPackageService packageService)
        : LanguageServiceLspAutoDownload(settingsService.GetSettingObservable<string>(VhdlModule.LspPathSetting), VhdlModule.RustHdlPackage,
            VhdlModule.LspName, workspace, packageService, settingsService.GetSettingObservable<bool>("Experimental_AutoDownloadBinaries"))
    {
