...
namespace OneWare.PackageManager.Services
{
    public partial class PackageService : ObservableObject, IPackageService
    {
        ...
        public List<string> PackageRepositories { get; } = new();

        private List<Package> StandalonePackages { get; } = new();
        ...
        {
            return Packages.TryGetValue(package.Id!, out var pkg) ? pkg : null;
        }
