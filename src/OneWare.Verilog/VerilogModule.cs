        ...
        [
                ...
                [
                    new PackageTarget()
                    {
                        ...
                        [
                            ...
                            {
                                RelativePath = Path.Combine("verible-v0.0-3582-g25611a89-win64", "verible-verilog-ls.exe"),
                    ...
                    new PackageTarget()
                    {
                        ...
                        [
                            new PackageAutoSetting()
                            {
                                RelativePath = Path.Combine("verible-v0.0-3582-g25611a89-macOS", "bin", "verible-verilog-ls"),
                                SettingKey = LspPathSetting
                            }
                        ]
                    }
            ...
            new PackageVersion()
            {
                ...
                [
                    ...
                    {
                        Target = "win-x64",
                        Url = "https://github.com/chipsalliance/verible/releases/download/v0.0-3716-g914652db/verible-v0.0-3716-g914652db-win64.zip",
                        AutoSetting =
                        [
                            new PackageAutoSetting()
                            {
                                RelativePath = Path.Combine("verible-v0.0-3716-g914652db-win64", "verible-verilog-ls.exe"),
                                SettingKey = LspPathSetting
                            }
                        ]
                    },
                    ...
                    {
                        Target = "linux-x64",
                        Url = "https://github.com/chipsalliance/verible/releases/download/v0.0-3716-g914652db/verible-v0.0-3716-g914652db-linux-static-x86_64.tar.gz",
                        AutoSetting =
                        [
                            new PackageAutoSetting()
                            {
                    ...
                    new PackageTarget()
                    {
                        ...
                        [
                            new PackageAutoSetting()
                            {
                                RelativePath = Path.Combine("verible-v0.0-3716-g914652db-macOS", "bin", "verible-verilog-ls"),
                                SettingKey = LspPathSetting
                            }
                        ]
                    }
