...
public class CppModule : IModule
{
    ...
    public void OnInitialized(IContainerProvider containerProvider)
    {
        ...
        containerProvider.Resolve<ISettingsService>().RegisterTitledPath("Languages", "C++", LspPathSetting, "Clangd Path", "Path for clangd executable", "", null, containerProvider.Resolve<IPaths>().NativeToolsDirectory, File.Exists);
