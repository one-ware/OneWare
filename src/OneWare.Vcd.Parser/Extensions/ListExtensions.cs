...
{
    public static int BinarySearchIndex<TItem, TSearch>(this IList<TItem> list, TSearch value, Func<TSearch, int, int, int> comparer)
    {
        if (list is null)
        {
        ...
        while (lower <= upper)
        {
            ...
            int comparisonResult = comparer(value, middle, middle + 1);
