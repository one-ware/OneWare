...
public static class LogicalExtensions
{
    ...
    public static T? FindLogicalAncestorWithDataContextType<T>(this ILogical? logical, bool includeSelf = false)
        where T : class
    {
        ...
        while (parent != null)
        {
            if (parent is StyledElement { DataContext: T dataContext }) return dataContext;
