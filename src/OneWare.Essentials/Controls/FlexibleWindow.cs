...
public class FlexibleWindow : UserControl
{
    ...
    public static readonly StyledProperty<IReadOnlyList<WindowTransparencyLevel>> TransparencyLevelHintProperty =
        AvaloniaProperty.Register<FlexibleWindow, IReadOnlyList<WindowTransparencyLevel>>(nameof(TransparencyLevelHint),
    ...
    public static readonly StyledProperty<bool> CloseOnDeactivatedProperty =
        AvaloniaProperty.Register<FlexibleWindow, bool>(nameof(CloseOnDeactivated));
        ...
        if (Application.Current?.ApplicationLifetime is IClassicDesktopStyleApplicationLifetime)
        {
            ...
            if (owner != null)
            {
                ...
                Host.Deactivated += (o, i) =>
                {
                    ...
                    if (CloseOnDeactivated) Dispatcher.UIThread.Post(Close);
                };
                Host.Show(owner);
            }
            else
