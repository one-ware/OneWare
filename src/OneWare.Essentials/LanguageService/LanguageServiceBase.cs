...
namespace OneWare.Essentials.LanguageService
{
    public abstract class LanguageServiceBase : ILanguageService
    {
        ...
        {
            return Task.WhenAll(DeactivateAsync(), Task.Delay(100), ActivateAsync());
        }
        ...
        public virtual Task<SignatureHelp?> RequestSignatureHelpAsync(string fullPath, Position pos, SignatureHelpTriggerKind triggerKind, string? triggerChar, bool isRetrigger, SignatureHelp? activeSignatureHelp)
        {
            return Task.FromResult<SignatureHelp?>(null);
        }

        public virtual Task<CommandOrCodeActionContainer?> RequestCodeActionAsync(string fullPath, Range range, Diagnostic diagnostic)
        {
        ...
        {
            var openDoc = _dockService.OpenFiles
