...
{
    public class HardwareGuiCreator
    {
        private readonly ILogger _logger;

        public Dictionary<string, IBrush> ColorShortcuts { get; } = new()
        {
            { "GND", Brushes.Cyan },
            { "1V2", Brushes.Yellow },
        ...
        public HardwareGuiCreator(ILogger logger)
        {
            _logger = logger;
        }

        public async Task<HardwareGuiViewModel> CreateGuiAsync(string guiPath, IHardwareModel hardwareModel)
        {
