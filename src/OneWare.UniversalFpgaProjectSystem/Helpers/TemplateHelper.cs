...
{
    public static void CopyDirectoryAndReplaceString(string sourcePath, string destPath, params (string source, string replacement)[] replacements)
    {
        ...
        foreach (var file in dir.GetFiles())
        {
            ...
            foreach (var (source, replacement) in replacements)
            {
                fileString = fileString.Replace(source, replacement);
            }
